/*You live in the city of Cartesia where all roads are laid out in a perfect grid. You arrived ten minutes too early to
 an appointment, so you decided to take the opportunity to go for a short walk. The city provides its
...
function isValidWalk(walk) {
   ...
   return east.length === west.length && north.length === south.length;
}

console.log(isValidWalk(['e','e','n','e','e','w','w','s','w','w']));// true